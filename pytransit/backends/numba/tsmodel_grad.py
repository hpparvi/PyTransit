...
from pytransit.backends.numba.rrmodel import calculate_weights_2d, interpolate_mean_limb_darkening_and_grad, \
    interpolate_mean_limb_darkening


@njit(fastmath=False)
def tsmodel_grad(times: ndarray,
