...
setup(name='pytransit',
      ...
      packages=['pytransit', 'pytransit.models', 'pytransit.models.numba', 'pytransit.models.roadrunner', 'pytransit.models.opencl', 'pytransit.orbits',
                'pytransit.utils', 'pytransit.param', 'pytransit.contamination','pytransit.lpf', 'pytransit.lpf.tess',
                'pytransit.lpf.baselines','pytransit.lpf.loglikelihood', 'pytransit.stars'],
      package_data={'':['*.cl'], 'pytransit.contamination':['data/*'], 'pytransit.stars':['data/*']},
